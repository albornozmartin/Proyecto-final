...
const ws2812_t YELLOW= {255, 215, 0};
const ws2812_t VIOLET= {138, 43, 226};
const ws2812_t ORANGE= {255, 69, 0};
const ws2812_t BROWN= {205, 133, 63};
const ws2812_t GREY = {105,105,105};
const ws2812_t PINK= {255, 20, 147};
//AGREGAR LOS DEMAS 
